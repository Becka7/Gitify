...
## Descriprion
This application consumes the GIthub API and allows users to saerch any user or repository .It also allows the users  to view the repositories on github
